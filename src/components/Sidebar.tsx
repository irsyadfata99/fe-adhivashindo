...
const IconDashboard = ({ active }: { active: boolean }) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <rect x="3" y="3" width="7" height="7" rx="1.5" fill={active ? "#4f46e5" : "#94a3b8"} />
    <rect x="14" y="3" width="7" height="7" rx="1.5" fill={active ? "#4f46e5" : "#94a3b8"} />
    <rect x="3" y="14" width="7" height="7" rx="1.5" fill={active ? "#4f46e5" : "#94a3b8"} />
    <rect x="14" y="14" width="7" height="7" rx="1.5" fill={active ? "#4f46e5" : "#94a3b8"} />
  </svg>
);

const IconModul = ({ active }: { active: boolean }) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={active ? "#4f46e5" : "#94a3b8"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
